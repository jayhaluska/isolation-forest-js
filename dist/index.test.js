...
test('Empty ITree has size 0', function () {
    var tree = new iTree_1.ITree([], 5);
    expect(tree.size()).toBe(0);
});
test('Isolation Forest.fit(), default values', function () {
...
test('averagePathLength(0)', function () {
    expect(iTree_1.averagePathLength(0)).toBe(0);
});
test('averagePathLength(1)', function () {
...
test('harmonicNumber(1)', function () {
    expect(iTree_1.harmonicNumber(1)).toBe(iTree_1.EULER_MASCHERONI);
});
